    ...
    return (
        <div className="relative min-h-screen w-full overflow-hidden">
            ...
            <div className="absolute inset-0">
                <div className="absolute top-20 left-10 w-48 h-48 md:w-72 md:h-72 bg-purple-500/20 rounded-full filter blur-[100px] animate-pulse" />
                <div className="absolute bottom-20 right-10 w-48 h-48 md:w-72 md:h-72 bg-blue-500/20 rounded-full filter blur-[100px] animate-pulse" />
            </div>
                    ...
                    <div className="max-w-4xl lg:max-w-6xl mx-auto px-4">
                        <div className="grid gap-8 lg:grid-cols-2 items-center">
                            ...
                            <div className="space-y-6 md:space-y-8">
                                <div>
                                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold font-mono mb-4 gradient-text">
                                        Who Am I?
                                    </h1>
                                ...
                                <div className="glass-effect rounded-xl p-4 sm:p-6 space-y-3 md:space-y-4 shadow-xl">
                                ...
                                {/* Social Links */}
                                <div className="flex items-center justify-start space-x-4 sm:space-x-6 pt-4">
                                    <SocialLink href="https://github.com/ImIshan7" icon={<Github className="w-5 h-5 sm:w-6 sm:h-6" />} />
                                    <SocialLink href="https://www.linkedin.com/in/ishan-dhananjana-615878226/" icon={<Linkedin className="w-5 h-5 sm:w-6 sm:h-6" />} />
                                    <SocialLink href="https://www.instagram.com/im_i__shan/" icon={<Instagram className="w-5 h-5 sm:w-6 sm:h-6" />} />
                                    <SocialLink href="https://twitter.com/ishandananjay10" icon={<Twitter className="w-5 h-5 sm:w-6 sm:h-6" />} />
                                    <SocialLink href="https://www.facebook.com/ishan.danu.9" icon={<Facebook className="w-5 h-5 sm:w-6 sm:h-6" />} />
                                </div>
                            </div>
                        </div>
                    </div>
...
const SocialLink: React.FC<SocialLinkProps> = ({ href, icon }) => (
    <a
        ...
        className="social-icon p-2 sm:p-3 rounded-full glass-effect hover:bg-white/20"
    >
        {icon}
    </a>
);
